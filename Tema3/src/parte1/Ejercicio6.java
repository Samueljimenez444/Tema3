...
public class Ejercicio6 {
	...
	public static void main(String[] args) {
		//Creamos el array entero numeros que servira para ir almacenando los distintos numeros del usuario
		int numeros[]=new int[8];
		//Creamos la variable entera usuario que servira para almacenar el numero introducido por el usuario
		int usuario;
